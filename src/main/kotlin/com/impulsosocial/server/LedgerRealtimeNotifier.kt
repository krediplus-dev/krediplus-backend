...
class LedgerRealtimeNotifier(
    ...
    fun start(scope: CoroutineScope) {
        ...
        val job = scope.launch(Dispatchers.IO) {
            ...
            while (isActive && !stopping) {
                ...
                try {
                    openRealtimeConnection("KrediPlus-Realtime-Ledger").use { connection ->
                        ...
                        try {
                            ...
                            logger.info("Kredi+: canal PostgreSQL de tiempo real conectado.")
                    ...
                    if (lastWarnAtMs == 0L || now - lastWarnAtMs >= 30_000L) {
                        logger.warn(
                            "Kredi+: canal de tiempo real temporalmente no disponible; nuevo intento en {} s. Causa: {}",
                            waitMs / 1_000L,
    ...
    fun stop() {
        ...
        logger.info("Kredi+: canal PostgreSQL de tiempo real detenido limpiamente.")
    }
